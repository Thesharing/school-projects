...
unsigned short int s_WAIT_R_RESP(char*dataBuf,int & reSendTimes,unsigned short int & sendSeqNo,CStdioFile *pfile,
								 REQPacket packet,SOCKET & commSock,sockaddr_in & t_from);
unsigned short int s_WAIT_ACK(char*dataBuf,int & reSendTimes,unsigned short int & sendSeqNo,CStdioFile *pfile,
